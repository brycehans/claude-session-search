...
- **resolve_project_dir**: Converts a real filesystem path (e.g. `/Users/bryce/Dev/foo`) to the matching `~/.claude/projects/-Users-bryce-Dev-foo` directory by replacing `/` with `-`
